...
const StoreModel = require("../models/store/auths.store.repo");
exports.isAuthStore = async (req, res, next) => {
  ...
  const user = await StoreModel.findUser(verified.payload.user_id);
